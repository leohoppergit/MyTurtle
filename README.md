...
[![GitHub Release](https://img.shields.io/github/v/release/leohoppergit/MyTurtle?display_name=tag&include_prereleases&label=GitHub%20Release)](https://github.com/leohoppergit/MyTurtle/releases/tag/v0.1.0-alpha)
...
Er ist bereits so vorkonfiguriert, dass auch `v0.1.0-alpha` als Pre-Release gefunden wird.
